    ...
    <div className="space-y-6">
      ...
      <div className="bg-factory-darkCard border border-factory-darkBorder rounded-xl overflow-hidden shadow-sm">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[880px] whitespace-nowrap">
            <thead>
      ...
      {showCreateModal && (
        ...
        >
          <div
            ...
            className="bg-factory-darkCard border border-factory-darkBorder rounded-xl max-w-2xl w-full p-4 sm:p-6 space-y-4 shadow-2xl animate-fade-in max-h-[94vh] sm:max-h-[90vh] overflow-y-auto cursor-default"
          >
